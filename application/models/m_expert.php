...
class m_expert extends CI_Model
{
  ...
  {
    $this->db->select('sme_list.nipp, sme_list.nama_sme, sme_list.bidang_keahlian_sme, sme_pengetahuan.nipp_sme, GROUP_CONCAT(sme_pengetahuan.id_pengetahuan SEPARATOR ";") as id_ilmu, GROUP_CONCAT(pengetahuan.nama_pengetahuan SEPARATOR ";") as nama_ilmu');
  ...
  {
    $this->db->select('sme_list.nipp, sme_list.nama_sme, GROUP_CONCAT(bidang_keahlian_sme SEPARATOR ";") as ahli, sme_pengetahuan.nipp_sme, GROUP_CONCAT(sme_pengetahuan.id_pengetahuan SEPARATOR ";") as id_ilmu, GROUP_CONCAT(pengetahuan.nama_pengetahuan SEPARATOR ";") as nama_ilmu');
    $this->db->from('sme_list');
    $this->db->join('sme_pengetahuan', 'sme_list.nipp = sme_pengetahuan.nipp_sme');
    $this->db->join('pengetahuan', 'sme_pengetahuan.id_pengetahuan = pengetahuan.id_pengetahuan');
