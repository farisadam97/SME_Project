						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="<?php echo base_url('login/aksi_login'); ?>" method="post">
								<div class="form-group m-form__group has-warning">
									<input class="form-control m-input m-form--state" type="text" placeholder="NIPP" name="nipp" autocomplete="on" required>
								</div>
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password" placeholder="Password" name="password">
								</div>
								<div id="infoMessage">
									<h6 style="color:red; text-align: center; padding-top: 20px"><?php echo $this->session->flashdata('message');?></h6>
								</div>
								<div class="m-login__form-action">
									<button id="m_login_signin_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary" type="submit" value="Login">
										Sign In
									</button>
								</div>
							</form>
